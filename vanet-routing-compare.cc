...
VanetRoutingExperiment::SetupScenario ()
{
  ...
  if (m_scenario == 1)
    ...
    {
      //58,129,185,282,374,440,490
      m_traceFile = "/home/rodrigo/mobility/mobility129.tcl";
      ...
      m_nodePause = 0;
      //m_nSinks = 20
      m_CSVfileName = "VANET_routing-compare.csv";
      m_CSVfileName = "VANET_routing-compare2.csv";
    }
}
